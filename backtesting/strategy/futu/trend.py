...
from strategy.futu.shortin import ShortIn
from strategy.futu.shortout import ShortOut
from strategy.futu.longin import LongIn
from strategy.futu.longout import LongOut
...
class FUTUTrend:
    ...
    def reset(self):
        ...
        # long
        self.long_in.long_out_close = None
        self.long_out.long_in_low = 0

        # short
        self.short_in.short_out_low = None
        self.short_out.short_in_high = None
